...
public class RotateCamera : MonoBehaviour
{
    ...
    void Update()
    {
        if(cam.GetComponent<Animator>().applyRootMotion == true && !escOptions.activeInHierarchy)
        {
            if (isEyeTracker.GetComponent<isEyeTrackerUsed>().isEyeTracker && isEyeTracker5)
            {
