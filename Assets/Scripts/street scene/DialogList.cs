...
public class DialogList : MonoBehaviour {
	...
	private void Awake() {  /// on load in, add text that say which button is the select button e.g. space bar 
		...
		string[] explanations = {
			...
			"First look at the canvas and select it.", " ",  "Here I've set up a scene with some shapes for you to practice. Whenever youre happy with a scene, select the green tick.", " ",
			" ", "Here is where you paint.", "In front of you is the image of the scene and on the left there is a canvas. To paint, you can either trace the shapes of whatevers in the scene with your eyes or draw freestyle on the canvas.",
			"First try looking at the Practice shapes and pressing your select button.", "Great, can you see the canvas to the left? That's what you've painted so far. To have a better look press the button at the top.",
			"You can also paint directly onto the canvas, have a go now.", "If you want to return to looking at the big picture of the scene you can click on the button at the top again.",
			"To the left you can choose to clear the canvas with the bin icon or complete the painting with the tick icon.",
			"When you decide the painting is done you will normally have the option to save the painting or throw it away. This one however won't be displayed as it is a practise piece.",
			"Practice as many times as you like, and secect the green tick when you want to move on. I'll leave you to it for now, if you need me select my icon.", " ",
			/// show banana painting 
			"Hey, not bad. You seem to have a knack for this, just need a bit more practice and we'll have some paintings to hang up around the place.", "I think you've earnt some better painting supplies. Let's try painting a still life scene with an apple.", " ",
			/// how to paint apple
			...
			"That looks great on the wall! You'll have this room filled in no time. Oh! I should give you your own painting space.", "Here I'll show on your museum map where to go.",
			"We are currently in the Still Life Display Room, here.", "Everything you need for now will be in the Restricted Area here. You'll have option to paint more and change any settings.",
			"Over here I'll set up a space for you to continue painting Still Life works.", "Oh, I can set up a Free Style area as well so you can paint whatever your heart desires.",
			...
			"Need a bit of help?", "Ok no worries.", "Sure. \nLook at the shapes or the canvas and hold your select button to paint. To change between the scene image and the canvas, select the button at the top.",
